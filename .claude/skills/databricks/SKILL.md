---
name: databricks
description: "Databricks CLI operations: auth, profiles, Unity Catalog, data exploration, jobs, pipelines, clusters, model serving, bundles and more. Use for all Databricks-related tasks."
---
